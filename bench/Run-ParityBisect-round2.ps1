...
$configs = @(
  @{ Tag = "default";     Extra = "" },
  @{ Tag = "l1_off";      Extra = "-Dnoisiumed.l1=false" },
  @{ Tag = "spec_off";    Extra = "-Dnoisiumed.density.specialize=false" },
  @{ Tag = "grid_off";    Extra = "-Dnoisiumed.cell.density.grid=false" },
  @{ Tag = "l1_spec_grid"; Extra = "-Dnoisiumed.l1=false`n-Dnoisiumed.density.specialize=false`n-Dnoisiumed.cell.density.grid=false" }
)
